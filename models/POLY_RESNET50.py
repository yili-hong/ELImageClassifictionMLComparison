...
from sklearn.metrics import (
    ...
    f1_score, hamming_loss, matthews_corrcoef, precision_score, recall_score
)
...
# evaluate model consistency across different random initializations of the data split
...
print(result)
w = csv.writer(open("poly_resnet50.csv", "w"))
